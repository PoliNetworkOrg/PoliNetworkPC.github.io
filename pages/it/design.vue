            ...
            <header class="jumbotron my-4 testoCentrale">
                ...
                <div style="text-align:center;">
                    <ul style="ulCcs">
                        ...
                        <li class="liCcs"><a class="topLinks" href="../design_corsi/default/">Design degli interni - Interior and spatial design</a></li>
                        <li class="liCcs"><a class="topLinks" href="../design_corsi/default/">Design & Engineering - Progetto e ingegnerizzazione del prodotto industriale</a></li>
                    </ul>
                </div>
            </header>
